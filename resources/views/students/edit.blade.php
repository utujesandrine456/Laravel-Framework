                    ...
                    <form action="{{ route('students.update', $student->id) }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('studentname') is-invalid @enderror" 
                                   id="studentname" name="studentname" value="{{ $student->studentname }}" required>
                            @error('studentname')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('course') is-invalid @enderror" 
                                   id="course" name="course" value="{{ $student->course }}" required>
                            @error('course')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('fee') is-invalid @enderror" 
                                   id="fee" name="fee" value="{{ $student->fee }}" required>
                            @error('fee')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
